...
if __name__ == '__main__':
    ...
    for plant in plants_data:
        ...
        content = plant.get("watering_long", "")
        if content:
            result = send_mistral(content, prompt)
            try:
                ...
                watering_period = result_json.get("watering_period")
                if watering_period is not None:
                    plant["watering_period"] = watering_period
