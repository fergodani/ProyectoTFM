...
if __name__ == '__main__':
    ...
    results = model.train(
        data='C:/Users/danix/Documents/Master/Segundo/TFM/Dataset', # <--- ¡CAMBIA ESTO!
        ...
        project='./results', # Carpeta donde se guardará todo
        name='plantify_model_v1',         # Subcarpeta del experimento
